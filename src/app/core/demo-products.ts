...
export const demoProductDetails: Record<string, ProductDetail> = {
  miku: {
    ...
    kitComponents: [],
    blanks: [{ id: 1, slug: 'phoi-tieu-chuan', name: 'Phôi tiêu chuẩn', size: '5–6 cm', imageUrl: mikuImage, images: [], priceVnd: 25000, sortOrder: 0, active: true }],
  },
  teto: {
    ...demoProducts[1],
    description:
    ...
    kitComponents: [],
    blanks: [{ id: 1, slug: 'phoi-tieu-chuan', name: 'Phôi tiêu chuẩn', size: '5–6 cm', imageUrl: tetoImage, images: [], priceVnd: 25000, sortOrder: 0, active: true }],
  },
};
